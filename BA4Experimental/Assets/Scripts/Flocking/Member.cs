...
public class Member : MonoBehaviour
{
    ...
    Vector3 Cohesion()
    {
        ...
        int countMembers = 0;
        var neighbors = level.GetNeighbors(this, config.cohesionRadius);
    ...
    Vector3 Alignment()
    {
        ...
        var members = level.GetNeighbors(this, config.alignmentRadius);
    ...
    Vector3 Separation()
    {
        ...
        var members = level.GetNeighbors(this, config.separationRadius);
